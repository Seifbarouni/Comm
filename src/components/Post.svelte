  ...
  <div class="bg-gray-800  cursor-pointer mt-16 p-4 rounded-md flex flex-col">
    <div id="header" class="flex items-center text-sm">
      ...
      <div class="text-gray-400">
        Posted by <a href="#/u/mark" class="hover:underline">u/mark</a> 3 hours ago
      </div>
    </div>
    <div>
      ...
      <div>
        ...
        vero beatae aspernatur nemo, rerum error debitis ut distinctio nesciunt
        dolor quo et hic tenetur id doloribus in quia cupiditate?
      </div>
    </div>
    ...
    <div class=" flex flex-col mt-4">
      ...
      <div class="flex items-start mt-2">
        ...
        <div>
          ...
          <div class="text-sm ml-2 pt-1">
            dolor sit amet consectetur adipisicing elit. Quidem blanditiis dsfd!
          </div>
          <div class="ml-2 -mt-2">
